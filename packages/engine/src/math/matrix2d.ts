...
export class Matrix2D {
    ...
    public static fromPoints(x: number | Vector2, y: number | Vector2, sx = 1, sy = 1): Matrix2D {
        if (x instanceof Vector2 && y instanceof Vector2) {
            const pos = x as Vector2;
            const scale = y as Vector2;
            return new Matrix2D(
                scale.x, 0, pos.x,
                0, scale.y, pos.y,
                0, 0, 1
    ...
    */
     ...
     * x x x
     */
    get 0(): number { return this.values[0]; }
    set 0(value: number) { this.values[0] = value; }
     ...
     * x x x
     */
    get 1(): number { return this.values[1]; }
    set 1(value: number) { this.values[1] = value; }
     ...
     * x x x
     */
    get 2(): number { return this.values[2]; }
    set 2(value: number) { this.values[2] = value; }
     ...
     * x x x
     */
    get 3(): number { return this.values[3]; }
    set 3(value: number) { this.values[3] = value; }
     ...
     * x x x
     */
    get 4(): number { return this.values[4]; }
    set 4(value: number) { this.values[4] = value; }
     ...
     * x x x
     */
    get 5(): number { return this.values[5]; }
    set 5(value: number) { this.values[5] = value; }
     ...
     * 0 x x
     */
    get 6(): number { return this.values[6]; }
    set 6(value: number) { this.values[6] = value; }
     ...
     * x 0 x
     */
    get 7(): number { return this.values[7]; }
    set 7(value: number) { this.values[7] = value; }
     ...
     * x x 0
     */
    get 8(): number { return this.values[8]; }
    set 8(value: number) { this.values[8] = value; }

    // Helper accessors
    // Scale
    get sx(): number { return this[0]; }
    get sy(): number { return this[4]; }
    
    // Translation
    get dx(): number { return this[2]; }
    get dy(): number { return this[5]; }
    ...
    add(other: Matrix2D): Matrix2D {
        ...
        this._values = [
            m0 + other[0], m1 + other[1], m2 + other[2],
            m3 + other[3], m4 + other[4], m5 + other[5],
            m6 + other[6], m7 + other[7], m8 + other[8],
        ]
        return this;
    }
    ...
    multiply(other: Matrix2D): Matrix2D {
        ...
        // First row
        const m0 = this[0] * other[0] + this[1] * other[3] + this[2] * other[6];
        const m1 = this[0] * other[1] + this[1] * other[4] + this[2] * other[7];
        const m2 = this[0] * other[2] + this[1] * other[5] + this[2] * other[8];
        // Second row
        const m3 = this[3] * other[0] + this[4] * other[3] + this[5] * other[6];
        const m4 = this[3] * other[1] + this[4] * other[4] + this[5] * other[7];
        const m5 = this[3] * other[2] + this[4] * other[5] + this[5] * other[8];
        // Third row
        const m6 = this[6] * other[0] + this[7] * other[3] + this[8] * other[6];
        const m7 = this[6] * other[1] + this[7] * other[4] + this[8] * other[7];
        const m8 = this[6] * other[2] + this[7] * other[5] + this[8] * other[8];
